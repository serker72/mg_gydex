...
.".$this->manmode[$this->mode]['inpname3'].".value=\"\";
					        ...
					        sel.text= \"\"+sm3+\"\";  
							 ...
							 opener.document.".$this->manmode[$this->mode]['formname']."
.".$this->manmode[$this->mode]['inpname4'].".focus(); 
							opener.document.".$this->manmode[$this->mode]['formname']."
.".$this->manmode[$this->mode]['inpname4'].".value=\"\"; 
					        sel = opener.document.selection.createRange(); 
					        sel.collapse();
					        sel.text= \"\"+sm4+\"\";  
...
.".$this->manmode[$this->mode]['inpname3'].".value = sm3+\"\";
						 opener.document.".$this->manmode[$this->mode]['formname']."
.".$this->manmode[$this->mode]['inpname4'].".value = sm4+\"\";
					}	
					}	
...
.".$this->manmode[$this->mode]['inpname'].".value = smilietext+\"\";
	...
	protected function DrawPhotoChangeSize($w,$h,$percent){
		...
		if($this->openmode[0]) $txt.="<input type=\"checkbox\" name=\"changeSize\" id=\"changeSize\" value=\"\" onchange=\"ss=document.getElementById('inisize'); if(this.checked){ ss.style.display='block';}else{ss.style.display='none';}\" checked><strong>Изменить размер</strong>";
		else $txt.="<input type=\"checkbox\" name=\"changeSize\" id=\"changeSize\" value=\"\" onchange=\"ss=document.getElementById('inisize'); if(this.checked){ ss.style.display='block';}else{ss.style.display='none';}\"><strong>Изменить размер</strong>";
		...
		$txt.='<table cellspacing="0" cellpadding="10" border="0">
			<tr>
			    <td valign="top">';
				$txt.="<input type=\"radio\" name=\"resize_kind\" value=\"0\" checked onchange=\"pp=document.getElementById('resize_basic_pixel'); pr=document.getElementById('resize_basic_percent'); pp.style.color='black'; pr.style.color='silver';\"><em>по пикселям</em>";
				...
				$txt.="<input type=\"radio\" name=\"resize_kind\" value=\"1\" onchange=\"pp=document.getElementById('resize_basic_pixel'); pr=document.getElementById('resize_basic_percent'); pp.style.color='silver'; pr.style.color='black';\"><em>по %</em>";		
	...
	protected function DrawPhotoAdditionalFile($no='',$prist='__',$indexmain='2',$indexsub='20',$w,$h){
		...
		if($this->openmode[$indexmain]){
			$txt.="<input type=\"checkbox\" name=\"makeAdd".$no."File\" id=\"makeAdd".$no."File\" value=\"\" onchange=\"ss=document.getElementById('add".$no."_file'); if(this.checked){ ss.style.display='block';}else{ss.style.display='none';}\" checked><strong>Создавать дополнительный файл</strong>";
			
			$txt.="<div id=\"add".$no."_file\" class=\"div_tools\" style=\"display: block; margin-left: 10px;\">";
		}else{
			$txt.="<input type=\"checkbox\" name=\"makeAdd".$no."File\" id=\"makeAdd".$no."File\" value=\"\" onchange=\"ss=document.getElementById('add".$no."_file'); if(this.checked){ ss.style.display='block';}else{ss.style.display='none';}\"><strong>Создавать дополнительный файл</strong>";
		...
		if($this->openmode[$indexsub]){
			$txt.="<input type=\"checkbox\" name=\"changeAdd".$no."File\" id=\"changeAdd".$no."File\" value=\"\" onchange=\"ss=document.getElementById('add".$no."size'); if(this.checked){ ss.style.display='block';}else{ss.style.display='none';}\" checked><strong>Менять размер файла</strong>";
			
			$txt.='<div id="add'.$no.'size" class="div_tools" style="display: block; margin-left: 10px; ">';
		}else{
			$txt.="<input type=\"checkbox\" name=\"changeAdd".$no."File\" id=\"changeAdd".$no."File\" value=\"\" onchange=\"ss=document.getElementById('add".$no."size'); if(this.checked){ ss.style.display='block';}else{ss.style.display='none';}\"><strong>Менять размер файла</strong>";
		...
		<tr>
		    <td valign="top">';
				...
				$txt.="<input type=\"radio\" name=\"add".$no."_resize_kind\" value=\"0\" checked onchange=\"pp=document.getElementById('add".$no."_resize_basic_pixel'); pr=document.getElementById('add".$no."_resize_basic_percent'); pp.style.color='black'; pr.style.color='silver';\"><em>по пикселям</em>";
				...
				$txt.="<input type=\"radio\" name=\"add".$no."_resize_kind\" value=\"1\" onchange=\"pp=document.getElementById('add".$no."_resize_basic_pixel'); pr=document.getElementById('add".$no."_resize_basic_percent'); pp.style.color='silver'; pr.style.color='black';\"><em>по %</em>";		
	...
	protected function DrawPhotoPreviewFile($w,$h){
		...
		if($this->openmode[1]){
			$txt.="<input type=\"checkbox\" name=\"doPreview\" id=\"doPreview\" value=\"\" onchange=\"ss=document.getElementById('presize'); if(this.checked){ ss.style.display='block';}else{ss.style.display='none';}\" checked><strong>Создавать превью</strong>";
			$txt.='<div id="presize" class="div_tools" style="display: block; margin-left: 10px;">';
		}else{
			$txt.="<input type=\"checkbox\" name=\"doPreview\" id=\"doPreview\" value=\"\" onchange=\"ss=document.getElementById('presize'); if(this.checked){ ss.style.display='block';}else{ss.style.display='none';}\"><strong>Создавать превью</strong>";
