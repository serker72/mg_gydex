...
$smarty->assign("SITETITLE",'Число. '.SITETITLE.'');
...
?>
	...
	CKEDITOR.replace( 'txt',
				...
				<label for="is_shown">Отображать на сайте:</label> <input class="unbord" name="is_shown" id="is_shown" type="checkbox" <? if(($action==1)&&($photo['is_shown']==1)) echo 'checked'; elseif($action==0) echo 'checked'; ?> /><p />
  ...
  frmvalidator.addValidation("number","req","Заполните  поле Число!");    
