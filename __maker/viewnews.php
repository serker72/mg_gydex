...
$smarty->assign("SITETITLE",'Список новостей - '.SITETITLE.'');
...
$_context->AddContext(new ContextItem( 18, 'a', "", "Создать новость", "ed_news.php?action=0&mid=".$id, false , $global_profile  ));
$_context->AddContext(new ContextItem( 18, 'r', "", "Все новости", "viewnews.php?sortmode=0&id=".$id, false , $global_profile  ));
...
$_context->AddContext(new ContextItem( "", '',  "", "Справка", "viewnews.html", true , $global_profile  ));
...
$_bc->AddContext(new BcItem('Список новостей', basename(__FILE__)));
...
?>
		...
		<h3><?
			...
			switch($sortmode){
				...
				break;
				case 1:
					echo 'Новости по дате: '.DateFromYmd($pdate);
