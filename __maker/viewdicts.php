...
$smarty->assign("SITETITLE",'Список словарей свойств - '.SITETITLE.'');
...
$_context->AddContext(new ContextItem( 22, 'a', "", "Создать словарь", "ed_dict.php?action=0", false , $global_profile  ));
 
$_context->AddContext(new ContextItem( "", '',  "", "Справка", "viewdicts.html", true , $global_profile  ));
...
$_bc->AddContext(new BcItem('Словари свойств', basename(__FILE__)));
