...
$smarty->assign("SITETITLE",'Права пользователей - '.SITETITLE.'');
...
$_context->AddContext(new ContextItem( "", '',  "", "Справка", "discr_matrix_user.html", true , $global_profile  ));
...
$_bc->AddContext(new BcItem('Пользователи и права', basename(__FILE__)));
...
<?
//$man= new DistrRightsManager;
//echo (int)$man->CheckAccess('test5', '3232', 'w', 5);
?>
...
echo $mg->Draw('discr/us_overal.html', false, $gfrom, $ofrom, 100);
?>
</div>
