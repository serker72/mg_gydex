...
$smarty->assign("SITETITLE",'ЧаВо - '.SITETITLE);
...
?>
	...
	if(isset($_GET['group_id'])) $group_id=(int)$_GET['group_id']; else $group_id=-1;
	if(isset($_GET['solution_id'])) $solution_id=(int)$_GET['solution_id']; else $solution_id=-1;
	
	echo $og->GetItems(0, 'faq/items.html', $from, $to_page,$group_id, $solution_id);
