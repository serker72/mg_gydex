<?php /* Smarty version 2.6.22, created on 2016-10-19 16:46:07
         compiled from papers/items.html */ ?>
<!-- список статей -->
...
_is_shown">видим</label>
	...
	<td width="15%" >
	<img src="/<?php echo $this->_tpl_vars['items'][$this->_sections['rowsec']['index']]['photopath']; ?>
" alt="" border="0">
	</td>	
	<td width="*" >
