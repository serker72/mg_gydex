...
$smarty->assign("SITETITLE",'Редактирование новости - '.SITETITLE.'');
...
?>
	...
	<?
	//навигация
	echo $razd->DrawNavig($mid, LANG_CODE,0,'правка новости');
	?>
	...
	?>
			...
			<strong>Местонахождение новости:</strong><br>
    ...
    <div id="full_upload">
		...
		<strong>Анонс новости:</strong><br />
	...
	CKEDITOR.replace( 'small_txt',
				...
				<strong>Текст новости:</strong><br />
	...
	CKEDITOR.replace( 'big_txt',
			...
			<strong>Текст новости 2:</strong><br />
	...
	<strong>Отображать на сайте:</strong> <input class="unbord" name="is_shown" type="checkbox" <? if(($action==1)&&($photo['is_shown']==1)) echo 'checked'; ?> /><p />
        ...
        <input name="doInp" id="doInp" type="submit" value="Внести изменения" onclick="" />
		<input name="doApply" id="doApply" type="submit" value="Применить изменения" onclick="" />
...
//  var  frmvalidator    =  new  Validator("inpp");  
 //frmvalidator.addValidation("mid","dontselect=0","Укажите местонахождение новости!");   
