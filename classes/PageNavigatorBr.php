...
////////////////////////////////////////////////////////////////////
class PageNavigatorBr extends PageNavigator{
//data members
	private $pagename;
	private $totalpages;
...
////////////////////////////////////////////////////////////////////
	public function getNavigator(){
		...
		if($this->currentpage==0){
			...
			$strnavigator .= $this->createLink(0, $this->strfirst, false);
		}
		...
		if($this->currentpage==$this->totalpages-1){
			...
			$strnavigator.=$this->createLink($this->currentpage + 1, $this->strnext, false);
		}
		//move last button
		if($this->currentpage==$this->totalpages-1){
...
////////////////////////////////////////////////////////////////////
	private function createInactiveSpans(){
		...
		$this->spanpreviousinactive="<span class=\"".
			"$this->inactivespanname\">$this->strprevious</span><br>\n";
